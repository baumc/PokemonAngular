...
- Create Angular project with ng: `ng new pokemonangular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`pokemonangular.client.esproj`).
